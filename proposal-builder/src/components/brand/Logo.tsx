...
export function Logo({
  ...
  const iconSize = height ? Math.round(height * 0.82) : 34;

  if (variant === "icon") {
    const size = width || 36;
    return (
      <Image
        src="/brand/netandsoft-icon.svg"
        alt="Net & Soft Solutions"
        width={size}
        height={size}
    ...
    <div className={`inline-flex items-center gap-3 select-none ${className}`}>
      <div className="relative shrink-0 flex items-center justify-center">
        <svg
          ...
          className="shrink-0"
        >
          {/* Three base puzzle pieces */}
          <path
            fill="#1F7A8C"
            d="M237.714,70.29c0-7.543,0-62.709,0-70.289H54.857C24.609,0.001,0,24.609,0,54.858v182.857c8.319,0,84.971,0,94.903,0
          ...
          <path
            fill="#1F7A8C"
            d="M457.143,0.001H274.286c0,8.319,0,84.971,0,94.903c0,14.069-15.265,22.86-27.427,15.837
          ...
          <path
            fill="#1F7A8C"
            d="M417.097,274.286c-14.069,0-22.857-15.264-15.837-27.427c5.605-9.71,5.342-21.116-0.078-30.503
          ...
          {/* Fourth piece (accent) */}
          <path
            fill={isDark ? "#38BDF8" : "#022B3A"}
            d="M295.645,348.52c-17.232-9.951-30.41,0.552-34.951,1.758c-11.621,3.087-22.979-5.704-22.979-17.674v-58.318h-33.718
      ...
      <div className="flex flex-col justify-center text-left leading-none">
        <span
          className={`font-black tracking-tight text-[17px] leading-tight ${
            isDark ? "text-white" : "text-[#022B3A]"
          }`}
        >
          Net &amp; Soft
        </span>
        <span
          className={`font-bold tracking-[0.14em] text-[10.5px] uppercase mt-0.5 ${
            isDark ? "text-[#38BDF8]" : "text-[#1F7A8C]"
          }`}
        >
          SOLUTIONS
        </span>
